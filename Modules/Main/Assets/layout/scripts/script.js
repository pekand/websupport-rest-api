...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function checkUserStatus() {
      this.spinner.show();
      getUrl('/user', 'get', null, this.receiveUserStatus.bind(this), this.receiveUserStatusError.bind(this));
    }
  }, {
    key: "receiveUserStatus",
    value: function receiveUserStatus(data) {
      this.spinner.hide();
    ...
    key: "receiveUserStatusError",
    value: function receiveUserStatusError(data) {
      this.spinner.hide();
    }
  }, {
    key: "afterUserSuccessLogin",
    value: function afterUserSuccessLogin(data, animation) {
      this.listpage.init(data);
      this.hideLoginPage(animation);
    }
  }, {
    key: "showLoginPage",
    value: function showLoginPage(animation) {
    ...
    key: "hideLoginPage",
    value: function hideLoginPage(animation) {
      this.loginbox.hide(animation);
    }
  }, {
    key: "showListPage",
    value: function showListPage(data) {
      this.listpage.show();
      this.hideLoginPage();
    }
  }, {
    key: "hideListPage",
    value: function hideListPage() {
      this.listpage.hide();
    }
  }, {
    key: "logout",
    value: function logout() {
      getUrl('/logout', 'get', null, this.afterLogout.bind(this), this.afterLogout.bind(this));
    }
  }, {
    key: "afterLogout",
    ...
    key: "afterLogoutAnimation",
    value: function afterLogoutAnimation() {
      this.listpage.hide();
      this.clean();
    }
  }, {
...
var FlashMessage = /*#__PURE__*/function () {
  ...
  _createClass(FlashMessage, [{
    ...
    key: "showAnimationFinished",
    value: function showAnimationFinished() {
      this.messageBox.classList.remove("flashmesage-show");
    }
  }, {
    key: "hideMessage",
    value: function hideMessage(messageEl) {
      messageEl.remove();
...
var ListPage = /*#__PURE__*/function () {
  ...
  _createClass(ListPage, [{
    ...
    key: "renderZones",
    value: function renderZones(zones) {
      this.zones = [];
      var oldZones = document.getElementsByClassName("zone");
      ...
      for (var _i = 0; _i < zones.length; _i++) {
        ...
        zone.setAttribute("id", "zone-" + zones[_i].id);
        zone.setAttribute("href", "#");
        zone.classList.add("zone");
        zone.classList.add("nav-link");
        zone.dataset.zoneid = zones[_i].id;
        zone.dataset.zonename = zones[_i].name;
        this.zoneNames[zones[_i].id] = zones[_i].name;
        zone.appendChild(document.createTextNode(zones[_i].name));
    ...
    key: "renderZonesRecords",
    value: function renderZonesRecords(zones, zoneRecords) {
      this.zoneRecords = [];
      var oldZoneRecords = document.getElementsByClassName("zone-records");

      for (var i = 0; i < oldZoneRecords.length; i++) {
        oldZoneRecords[i].remove();
      }

      for (var _i2 = 0; _i2 < zones.length; _i2++) {
        var zoneRecordsEl = document.createElement("div");
        zoneRecordsEl.setAttribute("id", "zone-records-" + zones[_i2].id); //getAttribute removeAttribute

        zoneRecordsEl.classList.add("zone-records");
        zoneRecordsEl.classList.add("row");
        zoneRecordsEl.classList.add("hidden");
        zoneRecordsEl.dataset.zoneid = zones[_i2].id;

        for (var j = 0; j < zoneRecords[zones[_i2].id].items.length; j++) {
          var zoneRecord = new ZoneRecord(this.app, zones[_i2].id, zoneRecords[zones[_i2].id].items[j]);
          zoneRecordsEl.appendChild(zoneRecord.element);
        }

        this.zoneRecords[zones[_i2].id] = zoneRecordsEl;
        this.recordslist.appendChild(zoneRecordsEl);
      }
    }
  }, {
    key: "getZoneRecord",
    value: function getZoneRecord(recordid) {
      if (this.data == null) {
        return null;
      }

      var zones = this.data.list_of_zones.items;
      var zoneRecords = this.data.zone_records;

      for (var i = 0; i < zones.length; i++) {
        for (var j = 0; j < zoneRecords[zones[i].id].items.length; j++) {
    ...
    key: "addZoneRecord",
    value: function addZoneRecord(zoneid, zoneRecord) {
      if (this.data == null) {
        return null;
      }
    ...
    key: "updateZoneRecord",
    value: function updateZoneRecord(zoneid, recordid, zoneRecord) {
      if (this.data == null) {
        return null;
      }

      for (var j = 0; j < this.data.zone_records[zoneid].items.length; j++) {
    ...
    key: "removeZoneRecord",
    value: function removeZoneRecord(zoneid, recordid) {
      if (this.data == null) {
        return null;
      }
    ...
    key: "showZone",
    value: function showZone(zoneid) {
      ...
      for (var _i3 = 0; _i3 < zoneRecords.length; _i3++) {
        zoneRecords[_i3].classList.add('hidden');
      }
    ...
    key: "addNewRecordClick",
    value: function addNewRecordClick() {
    ...
    value: function recordCreateButtonClick(event) {
      event.preventDefault();
      ...
      getUrl('/api/websupport/zone/' + this.zoneNames[this.selectedZone] + '/record/create', 'post', formData, this.receiveRecordCreate.bind(this), this.receiveRecordCreate.bind(this));
    }
  }, {
    key: "receiveRecordCreate",
    value: function receiveRecordCreate(data) {
      this.app.spinner.hide();

      if (typeof data.status != 'undefined' && data.status == 'success') {
        var zoneRecordsEl = document.getElementById("zone-records-" + data.item.zone.service_id);
    ...
    key: "updateRecord",
    value: function updateRecord(zoneRecordEl) {
      var recordid = zoneRecordEl.dataset.recordid;
      var zoneid = zoneRecordEl.dataset.zoneid;
      var zoneRecord = this.getZoneRecord(recordid);

      if (zoneRecord == null) {
        return;
      }

      var recordTypeRadio = document.getElementsByClassName("record-type");

      for (var i = 0; i < recordTypeRadio.length; i++) {
    ...
    value: function recordUpdateButtonClick(event) {
      ...
      this.app.spinner.show();
      getUrl('/api/websupport/zone/' + this.zoneNames[zoneid] + '/record/update/' + recordid, 'post', formData, this.receiveUpdateRecord.bind(this), this.receiveUpdateRecord.bind(this));
    }
  }, {
    key: "receiveUpdateRecord",
    value: function receiveUpdateRecord(data) {
      this.app.spinner.hide();
    ...
    key: "cleanRecordForm",
    value: function cleanRecordForm() {
      var recordTypeRadio = document.getElementsByClassName("record-type");
    ...
    key: "recordCancelButtonClick",
    value: function recordCancelButtonClick(e) {
      event.preventDefault();
      this.hideRecordForm();
    }
  }, {
...
var LoginBox = /*#__PURE__*/function () {
  ...
  _createClass(LoginBox, [{
    ...
    key: "loginFormSubmit",
    value: function loginFormSubmit(event) {
      event.preventDefault();
      var formData = {
      ...
      this.app.spinner.show();
      getUrl('/login/ajax', 'post', formData, this.receiveLoginForm.bind(this), this.receiveErrorLoginForm.bind(this));
    }
  }, {
    key: "receiveLoginForm",
    value: function receiveLoginForm(data) {
      this.app.spinner.hide();
    ...
    key: "receiveErrorLoginForm",
    value: function receiveErrorLoginForm() {
      this.app.spinner.hide();
    }
  }, {
    key: "clean",
...
var ZoneRecord = /*#__PURE__*/function () {
  function ZoneRecord(app, zoneid, zoneRecord) {
    _classCallCheck(this, ZoneRecord);

    this.app = app;
    this.element = this.render(zoneid, zoneRecord);
  }

  _createClass(ZoneRecord, [{
    key: "render",
    value: function render(zoneid, zoneRecord) {
      var zoneRecordEl = document.createElement("div");
      ...
      var zoneRecordRemoveEl = document.createElement("div");
      ...
      var zoneRecordRemoveConfirmEl = document.createElement("div");
      ...
      var zoneRecordRemoveConfirmTitleEl = document.createElement("div");
      ...
      var zoneRecordRemoveConfirmYesEl = document.createElement("button");
      ...
      var zoneRecordRemoveConfirmNoEl = document.createElement("button");
      ...
      var zoneRecordContainerEl = document.createElement("div");
    ...
    key: "updateRecordClick",
    value: function updateRecordClick(zoneRecordEl) {
      this.app.listpage.updateRecord(zoneRecordEl);
    }
  }, {
    key: "removeRecordClick",
    value: function removeRecordClick(e) {
      e.stopPropagation();
      var zoneRecordRemoveButton = e.target;
      var zoneRecordRemoveDialog = document.getElementById('zone-record-confirm-' + zoneRecordRemoveButton.dataset.zonerecordid);
    ...
    value: function receiveRemoveRecord(data) {
      this.app.spinner.hide();

      if (typeof data.status != 'undefined' && data.status == 'success') {
        var recordId = data.item.id;
        var recordEl = document.getElementById('zone-records-' + recordId);
    ...
    key: "removeAnimationFinished",
    value: function removeAnimationFinished(recordEl) {
      var zoneid = recordEl.dataset.zoneid;
      var recordid = recordEl.dataset.recordid;
      this.app.listpage.removeZoneRecord(zoneid, recordid);
      recordEl.remove();
    }
  }, {
    key: "removeRecordClickNo",
    value: function removeRecordClickNo(e) {
      e.stopPropagation();
      var zoneRecordRemoveButton = e.target;
      var zoneRecordRemoveDialog = document.getElementById('zone-record-confirm-' + zoneRecordRemoveButton.dataset.zonerecordid);
      zoneRecordRemoveDialog.classList.add('hidden');
